...
# The accuracy rate is not very good at 0.489

## Let's try a random forest
## I'm going to run this using 5 fold cross-validation
...
## I attempted to also fit a gbm model, but the package is not cooperating with my cpu. 
## Therefore, due to the high performance of the random forest model, this is the final model I'm using.
